...
public class ListAddAndDeleteDiffProcessor extends AbstractDiffProcessorTemplate {
    ...
    private String buildStrFromMap(List<Map<String, Object>> colMap, Map<String, String> columnCommentMap, List<String> columns, DiffDTO dto) {
        ...
        for (Map<String, Object> map : colMap) {
            ...
            for (String colum : columns) {
                ...
                String value = getClmValue(map.get(colum) == null ? "" : map.get(colum).toString(), colum, dto);
